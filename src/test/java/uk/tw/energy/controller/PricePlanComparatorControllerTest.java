...
public class PricePlanComparatorControllerTest {
    ...
    private static final String PRICE_PLAN_ID_KEY= "";
    private static final String PRICE_PLAN_COMPARISONS_KEY= "";
    ...
    public void setUp() {
        ...
        PricePlanService tariffService = new PricePlanServiceImpl(pricePlans, meterReadingService);
    ...
    public void shouldCalculateCostForMeterReadingsForEveryPricePlan() {
        ...
        expected.put(PRICE_PLAN_COMPARISONS_KEY, expectedPricePlanToCost);
    ...
    @Test
    public void testCalculatedPrevNaturalWeekCostForEachPricePlan() {
        //assertThat(controller.calculatedPrevNaturalWeekCostForEachPricePlan("not-found")).isNull();
        assertThat(controller.calculatedPrevNaturalWeekCostForEachPricePlan("not-found").getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
}
